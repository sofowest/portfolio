function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 text-white bg-indigo-950">
      ...
      <ul className="p-10">
        <li className="bg-blue-300 p-4 rounded-lg w-150 my-5">
      ...
      <ul className="flex gap-6 mt-4">
        <li>
          <a href="mailto:leandrogoezmdev@gmail.com" target="_blank" rel="noopener noreferrer" title="Email">
            {/* Email icon */}
            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-gray-800 hover:text-purple-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li>
          <a href="https://www.linkedin.com/in/leandro-g%C3%B3mez-739a92334/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
            {/* LinkedIn icon */}
            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-gray-800 hover:text-purple-900" viewBox="0 0 24 24" fill="currentColor">
